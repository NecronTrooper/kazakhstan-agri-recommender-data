...
Как найдено:
  ...
  бесплатном виджете (см. README.md, раздел "Внутренний рынок Казахстана"
  — там же про неудачную попытку вытащить оттуда больше через AJAX-
  эндпоинт и про Wayback Machine) — внутреннего тенгового рынка там нет.
  На grainunion.kz нашёлся именно внутренний
